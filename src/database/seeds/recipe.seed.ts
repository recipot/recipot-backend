  ...
  public async run(): Promise<void> {
    ...
    const recipesData = [
      ...
      // 1. 김치찌개
      {
        ...
        conditionName: '그럭저럭',
        images: [{ image_url: 'https://i.imgur.com/kFDU54j.jpeg' }],
        ingredients: [
          {
            name: '김치',
            amount: '300g',
          ...
          { name: '두부', amount: '1/2모', is_alternative: true },
          { name: '양파', amount: '1/4개', is_alternative: true },
        ],
        seasonings: [
        ...
        steps: [
          {
            ...
            image_url: 'https://i.imgur.com/kFDU54j.jpeg',
          },
          {
            order_num: 2,
            summary: '볶기',
      ...
      // 2. 된장찌개
      {
        ...
        duration: 'R01003', // 30분 이내
        conditionName: '그럭저럭',
        images: [{ image_url: 'https://i.imgur.com/A1O2d6c.jpeg' }],
        ingredients: [
          { name: '두부', amount: '1/2모', is_alternative: false },
          { name: '호박', amount: '1/4개', is_alternative: true },
          { name: '양파', amount: '1/4개', is_alternative: true },
          { name: '버섯', amount: '조금', is_alternative: true },
        ],
        seasonings: [
          { name: '된장', amount: '2큰술' },
        ...
        steps: [
          {
            ...
            image_url: 'https://i.imgur.com/A1O2d6c.jpeg',
          },
          {
            order_num: 2,
            summary: '된장 풀기',
      ...
      // 3. 고등어 구이
      {
        ...
        conditionName: '그럭저럭',
        images: [{ image_url: 'https://i.imgur.com/4l8dJmN.jpeg' }],
        ingredients: [
          { name: '고등어', amount: '1마리', is_alternative: false },
        ],
        seasonings: [
          { name: '소금', amount: '조금' },
          { name: '후춧가루', amount: '조금' },
        ...
        steps: [
          {
            ...
            image_url: 'https://i.imgur.com/4l8dJmN.jpeg',
          },
          {
            order_num: 2,
            summary: '굽기',
      ...
      // 4. 김치볶음밥
      {
        ...
        duration: 'R01002', // 20분 이내
        conditionName: '그럭저럭',
        images: [{ image_url: 'https://i.imgur.com/jgw82P3.jpeg' }],
        ingredients: [
          { name: '백미', amount: '1공기', is_alternative: false },
          { name: '김치', amount: '1/4포기', is_alternative: false },
        ],
        seasonings: [
          { name: '고추장', amount: '1큰술' },
        ...
        steps: [
          {
            ...
            image_url: 'https://i.imgur.com/jgw82P3.jpeg',
          },
          {
            order_num: 2,
            summary: '볶기',
      ...
      // 5. 감자전
      {
        ...
        duration: 'R01003', // 30분 이내
        conditionName: '그럭저럭',
        images: [{ image_url: 'https://i.imgur.com/h9d8f2S.jpeg' }],
        ingredients: [
          { name: '감자', amount: '3개', is_alternative: false },
          { name: '전분', amount: '2큰술', is_alternative: false },
        ],
        seasonings: [
        ...
        steps: [
          {
            ...
            image_url: 'https://i.imgur.com/h9d8f2S.jpeg',
          },
          {
            order_num: 2,
            summary: '반죽하기',
      ...
      // 6. 참치마요 덮밥
      {
        ...
        conditionName: '그럭저럭',
        images: [{ image_url: 'https://i.imgur.com/tT4fE8t.jpeg' }],
        ingredients: [
          { name: '백미', amount: '1공기', is_alternative: false },
          { name: '참치', amount: '1캔', is_alternative: false },
          { name: '마요네즈', amount: '3큰술', is_alternative: false },
        ],
        seasonings: [
          { name: '간장', amount: '1큰술' },
          { name: '설탕', amount: '0.5큰술' },
        ...
        steps: [
          {
            ...
            image_url: 'https://i.imgur.com/tT4fE8t.jpeg',
          },
          {
            order_num: 2,
            summary: '올리기',
      ...
      // 7. 떡볶이
      {
        ...
        duration: 'R01002', // 20분 이내
        conditionName: '그럭저럭',
        images: [{ image_url: 'https://i.imgur.com/oB4dY6c.jpeg' }],
        ingredients: [
          { name: '밀떡', amount: '300g', is_alternative: true },
          { name: '어묵', amount: '2장', is_alternative: true },
        ],
        seasonings: [
          { name: '고추장', amount: '3큰술' },
          { name: '설탕', amount: '2큰술' },
        ...
        steps: [
          {
            ...
            image_url: 'https://i.imgur.com/oB4dY6c.jpeg',
          },
          {
            order_num: 2,
            summary: '끓이기',
      ...
      // 8. 어묵탕
      {
        ...
        duration: 'R01002', // 20분 이내
        conditionName: '그럭저럭',
        images: [{ image_url: 'https://i.imgur.com/sJ5gX2e.jpeg' }],
        ingredients: [
          { name: '어묵', amount: '300g', is_alternative: false },
          { name: '무', amount: '1/5개', is_alternative: true },
        ],
        seasonings: [
          { name: '국간장', amount: '2큰술' },
          { name: '소금', amount: '조금' },
        ...
        steps: [
          {
            ...
            image_url: 'https://i.imgur.com/sJ5gX2e.jpeg',
          },
          {
            order_num: 2,
            summary: '끓이기',
      ...
      // 9. 토마토 스파게티
      {
        ...
        duration: 'R01002', // 20분 이내
        conditionName: '그럭저럭',
        images: [{ image_url: 'https://i.imgur.com/Y7aLp2p.jpeg' }],
        ingredients: [
          { name: '파스타', amount: '1인분', is_alternative: false },
          {
            name: '스파게티 소스',
            amount: '150g',
            is_alternative: false,
        ...
        steps: [
          {
            ...
            image_url: 'https://i.imgur.com/Y7aLp2p.jpeg',
          },
          {
            order_num: 2,
            summary: '소스 끓이기',
      ...
      // 10. 알리오 올리오
      {
        ...
        duration: 'R01002', // 20분 이내
        conditionName: '그럭저럭',
        images: [{ image_url: 'https://i.imgur.com/5gXyZ8R.jpeg' }],
        ingredients: [
          { name: '파스타', amount: '1인분', is_alternative: false },
        ],
        seasonings: [
        ...
        steps: [
          {
            ...
            image_url: 'https://i.imgur.com/5gXyZ8R.jpeg',
          },
          {
            order_num: 2,
            summary: '마늘 볶기',
    ...
    for (const data of recipesData) {
      ...
      const recipe = recipeRepository.create({
        ...
        condition_id: conditionMap.get(data.conditionName),
      });
      ...
      if (data.seasonings && data.seasonings.length > 0) {
        const seasonings = data.seasonings.map((s) =>
          recipeSeasoningRepository.create({
            ...s,
            seasoning_id: seasoningMap.get(s.name),
            recipe_id: savedRecipe.id,
          }),
        );
